...
public class MyDBInfo {	
	public static final String MYSQL_USERNAME = "ccs108ohuang";
	public static final String MYSQL_PASSWORD = "4XrW8JPWMnHzQxwr";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_ohuang";
}
